...
import { useFetchVendors } from '@/api/users/vendors'
import { vendors_column } from '@/components/dashboard/columns/vendors-column'
...
function Page() {
    ...
    const {data, isLoading} = useFetchVendors(query);
    ...
    return (
        <div className='p-5 border'>
            <h4 className='text-[#252424] text-3xl font-bold mb-6'>Vendors</h4>
