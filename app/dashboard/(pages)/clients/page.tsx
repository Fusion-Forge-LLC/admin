            ...
            {!isLoading && <div className='py-4 flex items-center justify-between'>
                ...
                <div className='flex items-center border border-[#D5D5D5] bg-[#FAFBFD] w-fit rounded-[8px] overflow-hidden'>
                    <button
                        ...
                        className='px-2 sm:px-4 py-1.5 sm:py-2.5 border-r border-r-[#D5D5D5] disabled:bg-muted disabled:cursor-not-allowed'
                        onClick={prevPage}
                    >
                        <ChevronLeft />
                    </button>
                    <button
                        ...
                        className='px-2 sm:px-4 py-1.5 sm:py-2.5 disabled:bg-muted disabled:cursor-not-allowed'
                        onClick={nextPage}
                    >
                        <ChevronRight />
                    </button>
